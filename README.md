...
`[Already we written dependencies and Tools installation script & Just Download and run it in linux machine](https://github.com/V33RU/BLE-UAE/blob/master/tools_installation.sh)`
